        ...
        series: [
            {
                ...
                data:[
                    {value:335, name:'Data1', itemStyle: {color: '#6aa222',}},
                    {value:310, name:'Data2', itemStyle: {color: '#001f71',}},
                    {value:234, name:'Data3', itemStyle: {color: '#3a4b60',}},
                    {value:135, name:'Data4', itemStyle: {color: '#6c7989',}},
                ...
                itemStyle: {
                    normal: {
                        color: new echarts.graphic.LinearGradient(
                            0, 0, 0, 1,
                            [
                                {offset: 0, color: '#83b93e'},
                                {offset: 0.5, color: '#6aa222'},
                                {offset: 1, color: '#6aa222'}
                            ]
                        )
                    },
                    emphasis: {
